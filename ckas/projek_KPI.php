...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo '<center><h>KPI.BHG.KEJ.AWAM(KKPT&P)</h></center><br/>';
$cday = date(d);
$cmonth = date(m);
$cmonth1 = date(m)-1;
$cmonth2 = date(m)-2;
...
<tr><span style=\"align: center; height: 50px; font-size: 16px; color: #000\">LAPORAN KEMAJUAN BULANAN</span></tr></center>";
	...
	<tr>
		...
		<td valign=\"top\" align=\"center\" width=\"110\"><font size=\"2\" color=\"orange\"><a href=\"projek_KPI_butiran.php?bka=$dataco0-PERANCANGAN\">$cnt2</a></font></td>
		<td valign=\"top\" align=\"center\" width=\"110\"><font size=\"2\" color=\"black\"><a href=\"projek_KPI_butiran.php?bka=$dataco0-REKABENTUK\">$cnt3</a></font></td>
		<td valign=\"top\" align=\"center\" width=\"110\"><font size=\"2\" color=\"coral\"><a href=\"projek_KPI_butiran.php?bka=$dataco0-PEROLEHAN\">$cnt4</a></font></td>
		<td valign=\"top\" align=\"center\" width=\"110\"><font size=\"2\" color=\"orange\"><a href=\"projek_KPI_butiran.php?bka=$dataco0-PEMBINAAN\">$cnt5</a></font></td>
		<td valign=\"top\" align=\"center\" width=\"110\"><font size=\"2\" color=\"black\"><a href=\"projek_KPI_butiran.php?bka=$dataco0-SERAHAN\">$cnt6</a></font></td>
		<td valign=\"top\" align=\"center\" width=\"110\"><font size=\"2\" color=\"black\"><a href=\"projek_KPI_butiran.php?bka=$dataco0-TANGGUH\">$cnt1</a></font></td>
