...
<?php
//$chkOr = 0 ; $chkWh = 0 ;
//echo $_SESSION['kp_s']."::SESSION-kp_s";
?>
<?php
...
switch ( $kes ){
	...
	case 29: $order_temp ='WHERE t1.mod_kerja  = \'Inhouse\' AND t1.OIC = \'KPPK(Ksel)\' ORDER BY t1.tajuk ASC'; break;
...
echo "<center> As'Salam , {$_SESSION['first_name']} !";
