...
function getXMLfile(labeler) {
   ...
   request = GXmlHttp.create();
	...
	var numdist = '03';  //var numdist = labeler.substring(1,4);
   gmarkers=labeler;
  ...
  if (request.readyState == 4) {
    if (request.status == 200) {
       ...
       if (xmlDoc.documentElement) {
	    ...
	    var numdist = '03';  //var numdist = gmarkers.substring(1,4);
	...
	var pts = [];
		...
		pol++;
              ...
              map.addOverlay(new GPolygon(pts, null, 5, 0.7, "#ccaaff", 0.3 ));
...
// 
  ...
  icon.image = "images/marker" + gmarkers + ".png";
