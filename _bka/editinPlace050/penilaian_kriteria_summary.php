...
for ($j=1;$j<=$bilPetender;$j++){ 	
echo "$('PETENDER".$j."#".$chk_id."').editInPlace({form_type:'textarea'});";}

echo " $('PeratusAwam#".$chk_id."').editInPlace();"; 
for ($j=1;$j<=$bilPetender;$j++){ 
echo "$('UlasanPositif".$j."#".$chk_id."').editInPlace({form_type:'textarea'});";
echo "$('UlasanNegatif".$j."#".$chk_id."').editInPlace({form_type:'textarea'});";
echo "$('UlasanRumusan".$j."#".$chk_id."').editInPlace({form_type:'textarea'});";
}

	
for ($j=1;$j<=$bilPetender;$j++){ 
echo "$('gredBesar".$j."#".$chk_id."').editInPlace({form_type:'textarea'});";
echo "$('skorBesar".$j."#".$chk_id."').editInPlace({form_type:'textarea'});";
echo "$('GredSelaras".$j."#".$chk_id."').editInPlace({form_type:'textarea'});";
echo "$('SkorSelaras".$j."#".$chk_id."').editInPlace({form_type:'textarea'});";
}
