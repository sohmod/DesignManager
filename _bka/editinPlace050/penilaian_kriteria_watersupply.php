...
<html>
<head>	
	<title>eggBlog - pt_watersupply</title>
...
<br/>
<font color="gray">EditInPlace - <b>Penilaian</b> Teknikal Kerja Sivil : </font><font color="red">Watersupply</font>
...
<span id="item_'.$scope.'#'.$chk_id.'">'.$item[400].'</span></td>
<td colspan="2" width="380" bgcolor="#FFFFFF" style="align:center;padding-left: 5px;font-size:12px">'.$kriteria[400].'</td>
...
$chk_d1="gred411".$j."#".$chk_id;$chk_d2="gred412".$j."#".$chk_id;$chk_d3="gred413".$j."#".$chk_id;;$chk_d4="gred414".$j."#".$chk_id;

$chk_c1="gred421".$j."#".$chk_id;   //$chk_c2="gred422".$j."#".$chk_id;

$chk_p1="gred431".$j."#".$chk_id;$chk_p2="gred432".$j."#".$chk_id;$chk_p3="gred433".$j."#".$chk_id;$chk_p4="gred434".$j."#".$chk_id;
...
$sumgred1=$sumg[0];  // 3 el
            ...
            $result=mysql_query("SELECT SUM(new_content) FROM kriteria where (id='$chk_c1')") or die ('Error performing query');
$sumg=mysql_fetch_array($result);	  
...
$sumskor2 = floatval($sumgred2)*floatval($wtg_2)/(1*5);
...
<span id="gred40'.$j.'#'.$chk_id.'"><b>'. $sumgred .'</b></span></td>';
echo '<td bgcolor="#FDFECF" bordercolor="#EBEEF5" style="align:center;padding-left: 20px;font-size:11px">
<span id="skor40'.$j.'#'.$chk_id.'"><b>'.$sumskor.'</b></span></td>';		
InsertUpdata('skor40'.$j.'#'.$chk_id, $sumskor, $chk_id, $username, $kp ,$ajaxHost,$ajaxULogin,$ajaxPass,$ajaxDbase);
InsertUpdata('gred40'.$j.'#'.$chk_id, $sumgred, $chk_id, $username, $kp ,$ajaxHost,$ajaxULogin,$ajaxPass,$ajaxDbase);
...
$id_daftar = $row['id_daftar'];
		...
		$gred = $new_content; $new_content='';
$skor = floatval($gred)*floatval($weightage)/(1*5);
$skor = round($skor,2);
echo '<td bgcolor="#FFFFFF" style="align:center;padding-left: 20px;font-size:11px">
<span id="gred'.$nitm.$j.'#'.$chk_id.'">'.$gred.'</span></td>
<td bgcolor="#FFFFFF" style="align:center;padding-left: 20px;font-size:11px">
...
for ($j=1;$j<=$bilPetender;$j++){ 	
	echo " $('skor40".$j."#".$chk_id."').editInPlace({	form_type: 'textarea'});
	$('gred40".$j."#".$chk_id."').editInPlace({	form_type: 'textarea'});
