...
<html>
<head>	
	<title>eggBlog - pt_sewerage</title>
...
<br/>
<font color="gray">EditInPlace - <b>Penilaian</b> Teknikal Kerja Sivil : </font><font color="red">Sewerage</font>
...
<span id="item_'.$scope.'#'.$chk_id.'">'.$item[500].'</span></td>
<td colspan="2" width="380" bgcolor="#FFFFFF" style="align:center;padding-left: 5px;font-size:12px">'.$kriteria[500].'</td>
...
$chk_d1="gred511".$j."#".$chk_id;$chk_d2="gred512".$j."#".$chk_id;$chk_d3="gred513".$j."#".$chk_id;;$chk_d4="gred514".$j."#".$chk_id;

$chk_c1="gred521".$j."#".$chk_id;  //$chk_c2="gred522".$j."#".$chk_id;

$chk_p1="gred531".$j."#".$chk_id;$chk_p2="gred532".$j."#".$chk_id;$chk_p3="gred533".$j."#".$chk_id;$chk_p4="gred534".$j."#".$chk_id;
...
<span id="gred50'.$j.'#'.$chk_id.'"><b>'. $sumgred .'</b></span></td>';
echo '<td bgcolor="#FDFECF" bordercolor="#EBEEF5" style="align:center;padding-left: 20px;font-size:11px">
<span id="skor50'.$j.'#'.$chk_id.'"><b>'.$sumskor.'</b></span></td>';		
InsertUpdata('skor50'.$j.'#'.$chk_id, $sumskor, $chk_id, $username, $kp ,$ajaxHost,$ajaxULogin,$ajaxPass,$ajaxDbase);
InsertUpdata('gred50'.$j.'#'.$chk_id, $sumgred, $chk_id, $username, $kp ,$ajaxHost,$ajaxULogin,$ajaxPass,$ajaxDbase);
...
for ($j=1;$j<=$bilPetender;$j++){ 	
	echo " $('skor50".$j."#".$chk_id."').editInPlace({	form_type: 'textarea'});
	$('gred50".$j."#".$chk_id."').editInPlace({	form_type: 'textarea'});
