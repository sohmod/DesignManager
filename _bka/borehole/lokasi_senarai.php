...
<div><small><a href=\"peserta_tdbr.php?usm={$row[KodKursus]}\"><small>{$row[KodKursus]}</a></small></div>
		...
		<td align=\"center\" width=\"100\" bgcolor=\"#FDFECF\">
			<div align=\"center\"><a href=\"../../_bka/liveForms/MyLogofBoring.php?edit={$row[idy]}\"  style=\"display: block; width: 100%; height: 100%; text-decoration: none;\"><small>{$bil}</small></a></div>
		</td>
		<td width=\"100\">
              <div align=\"center\"><a href=\"../../_bka/liveForms/MyLogofBoring.php?edit={$row[idy]}\"  style=\"display: block; width: 100%; height: 100%; text-decoration: none;\"><small>{$row[trk_bore]}</small></a></div>
            </td>
		<td width=\"150\">
              <div align=\"center\"><a href=\"../../_bka/liveForms/MyLogofBoring.php?edit={$row[idy]}\"  style=\"display: block; width: 100%; height: 100%; text-decoration: none;\"><small>{$row[lat]}</small></a></div>
            </td>
		<td width=\"150\">
              <div align=\"center\"><a href=\"../../_bka/liveForms/MyLogofBoring.php?edit={$row[idy]}\"  style=\"display: block; width: 100%; height: 100%; text-decoration: none;\"><small>{$row[lng]}</small></a></div>
            </td>
		<td width=\"75\">
              <div align=\"center\"><a href=\"../../_bka/liveForms/MyLogofBoring.php?edit={$row[idy]}\"  style=\"display: block; width: 100%; height: 100%; text-decoration: none;\"><small>{$row[ground_lvl]}</small></a></div>
            </td>			
		<td width=\"75\">
              <div align=\"center\"><a href=\"../../_bka/liveForms/MyLogofBoring.php?edit={$row[idy]}\"  style=\"display: block; width: 100%; height: 100%; text-decoration: none;\"><small>{$row[water_lvl]}</small></a></div>
            </td>			
		<td width=\"200\">
        <div align=\"left\"><a href=\"../../_bka/liveForms/MyLogofBoring.php?edit={$row[idy]}\"  style=\"display: block; width: 100%; height: 100%; text-decoration: none;\"><span style=\"font-size:8px;margin-left:10px;\">{$row[catatan]}</span></a></div>
            </td>			
          </tr>";} 
