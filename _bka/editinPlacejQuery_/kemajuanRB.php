...
<html>
<head>	
	<title>eggBlog - kemajuanRB</title>
...
Tarikh:<br/><small><i>( format 01/12/2006 )</i></small>
</td>
...
<a href="http://'.$ipthis.'/_bka/editinPlacejQuery/cartakemajuanRM9.php" style="text-decoration: none;">
Kemajuan :</a>
</td>';
for ($j=1;$j<=$bilcol;$j++){ 
