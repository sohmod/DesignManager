...
<html>
<head>	
	<title>eggBlog - _pkO_02_dua</title>
...
KAJIAN SEMULA / VERIFIKASI / VALIDASI (*) Kerja Sivil : </font><font color="red">General</font><font color="green">&nbsp;&nbsp;Job no:>'.$chk_id.'</font><br/>

<!--a href="http://'.$ipthis.'/_bka/editinPlacejQuery/JKR.PK(O).02-2.php"><font color="green" size="2em" style="text-decoration:none"-->general<!--/font></a-->
...
&nbsp;:&nbsp;&nbsp;&nbsp;
<a href="http://'.$ipthis.'/pdf/tcpdf_3_0_006/examples/bka_L-A4_ulasanteknikal_JQ.php"><font color="green" size="2em" style="text-decoration:none">PDF_A4</font></a>';
...
$chk='skopbincang-'.$chk_id; $result=mysql_query("SELECT new_value FROM jkr_pko_02_dua where id='$chk'") or die ('Error performing query'); while($row=mysql_fetch_array($result, MYSQL_ASSOC)){ $skopbincang  = $row['new_value'];	} if (empty($skopbincang)){$skopbincang = '<i>Klik2Edit</i>'; }
echo '<tr><td bgcolor="#FFFFFF" width="200" valign="top" style="align:center;padding-left: 5px;font-size:12px;padding-top: 5px;padding-bottom: 5px"><b>SKOP PERBINCANGAN</b></td><td colspan="2" bgcolor="#FFFFFF" width="600" valign="top" style="align:center;padding-left: px;font-size:12px;padding-top: 5px;padding-bottom: 5px"><span id="'.$chk.'">'.$skopbincang.'</span></td></tr>';
$skopbincang = '';
...
$setID .= '$("#skopbincang-'.$chk_id.'").eip("save_jkr_pkO_02_dua.php", { form_type: "textarea", max_rows:2, cols:60 });';
