...
<html>
<head>	
	<title>Log of Boring viewonly</title>
...
if ($db = @mysql_connect (DB_HOST, DB_USER, DB_PASSWORD)) {
 ...
 if ( $chkoic<>''){
 	...
 	//$query = "DELETE FROM eb_fieldrecord WHERE idz='$id'";		
			...
			echo '<small>::Data '.$id.'<font color="red" size="-1"> mysql_error:'.mysql_error().'</font>: no data deleted.</small>'; 	
			}  
endif; 		     
		}
?>
...
<a href="<?php echo "http://".$ipthis."/_bka/liveForms/MyBulkDrawings11.php" ;?>">D.Lukisan</a>
	...
	<form id="liveForm" action="MyLogofBoring_viewonly.php" method="post" onsubmit="if(!Validator.AllFieldsValidated()) return false;">
...
<div><textarea cols="84" rows="2" id="tajuk" name="tajuk" onblur="Validator.Validate(this,'tajuklukisan');"></textarea>
...
'<small>To view existing data, paste double semi-colons ( ;; ) in the input box, <br>then click outside to activate show button.</small>'; ?>			
	
		<div id="innerFieldset">
			<noscript>
				<input name="submit" id="submit" type="submit" value="Show Data" class="action" />
			</noscript>
		</div>
		<script type="text/javascript">
			gebid('innerFieldset').innerHTML = '<input name="submit" id="submit" type="submit" value="Show Data" style="width: 100px;" disabled="true" />';
		</script>
...
<a href="../borehole/lokasi_senarai_viewonly.php"><small>&nbsp;&nbsp;lokasiBH</small></a>
	    </tr></table></left>';
...
print "<left><table width=\"700\" border=\"1\" cellspacing=\"1\" cellpadding=\"0\" bordercolor=\"#E4F3CF\" bgcolor=\"#ffffff\" >
		...
		<a href=\"MyLogofBoring_viewonly.php?delete=".$id."&deep=".$depth."\" onCLick=\"return confirmDelete();\" style=\"display: block; width: 100%; height: 100%; text-decoration: none;\" title=\"Delete this data row\"><font color=\"#000000\" size=\"1\" margin-left=\"10\">&nbsp;".$classification."</font></a>
            </td>
	    </tr>
        </table></left>";
