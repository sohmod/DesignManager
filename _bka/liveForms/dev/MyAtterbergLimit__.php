...
if ($changeKP <> '' && $classification <>''){						
			$query_eb = "INSERT INTO eb_atterberglimit (idy, depth, n1, n2, n3, n4, n5, n6, rratio, classification, regist_date) VALUES ({$_SESSION['idy']}, '$depth', '$n1', '$n2', '$n3', '$n4', '$n5', '$n6', '$rratio', '$classification', NOW())";	
...
$BIL=1;  
    $result=mysql_query("SELECT * FROM eb_atterberglimit WHERE idy={$_SESSION['idy']} ORDER BY depth ASC") or die ('Error performing query');
