...
<form id="liveForm" action="tnaPeranan.php" method="post" onsubmit="if(!Validator.AllFieldsValidated()) return false;">
...
?>
			...
			<p>Edit/Update Description Peranan ini<br/><input type="text" size="80" id="tajuklukisan" name="tajuklukisan"  onchange="Validator.Validate(this);" onblur="Validator.Validate(this);" value="<?php echo $description; ?>" /></p>
			
			<p>Nombor Keutamaan : <br/><input type="text" size="5" id="nomborlukisan" name="nomborlukisan"  onchange="Validator.Validate(this);" onblur="Validator.Validate(this);" value="<?php echo $Bilangan; ?>" /></p>			
...
<input name="id" type="hidden" id="id" value="<?php echo $id;?>">
		...
		<div id="innerFieldset">
			<noscript>
				<input name="submit" id="submit" type="submit" value="Update Peranan" class="action" />

			</noscript>
		</div>
		<script type="text/javascript">
			gebid('innerFieldset').innerHTML = '<input name="submit" id="submit" type="submit" value="Update Peranan" style="width: 100px;" disabled="true" />';
		</script>
	</form>
