...
list($n1, $n2, $n3, $n4, $n5, $n6, $n7) = explode(' ', $spt);
/*$n1=intval($n1); $n2=intval($n2); $n3=intval($n3); 
$n4=intval($n4); $n5=intval($n5); $n6=intval($n6);
if ($n1==0){$n1='';}
if ($n2==0){$n2='';}
if ($n3==0){$n3='';}
if ($n4==0){$n4='';}
...
if ($changeKP <> '' && $classification <>'' && $count<=75){						
			$query_eb = "INSERT INTO eb_fieldrecord (idy, depth, n1, n2, n3, n4, n5, n6, n7, rratio, classification, regist_date) VALUES ({$_SESSION['idy']}, '$depth', '$n1', '$n2', '$n3', '$n4', '$n5', '$n6', '$n7', '$rratio', '$classification', NOW())";	
...
<div><tr><small>Input style::</small><td><font color="coral" size="3px">&nbsp;&nbsp;#&nbsp;&nbsp;</font></td><td><small> Test Depth </small></td><td><font color="coral" size="3px">&nbsp;&nbsp;;&nbsp;&nbsp;</font></td><td><small> 6SPT&nbsp;&nbsp;&nbsp;1N</small></td><td><font color="coral" size="3px">&nbsp;&nbsp;;&nbsp;&nbsp;</font></td><td><small> R-ratio </small></td><td><font color="coral" size="3px">&nbsp;&nbsp;;&nbsp;&nbsp;</font></td><td><small> Soil Description </small></td><td><font color="coral" size="3px">&nbsp;&nbsp;#&nbsp;&nbsp;&nbsp;</font></td></tr><small><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Contoh::</small>&nbsp;&nbsp;&nbsp;&nbsp;
<tr><td><font color="green" size="2px">&nbsp;#&nbsp;&nbsp;&nbsp;</font></td><td><font color="green" size="1px"> 3.55 </font></td><td><font color="green" size="2px">&nbsp;&nbsp;&nbsp;;&nbsp;&nbsp;&nbsp;</font></td><td><font color="green" size="1px"> 2 2 3 6 5 6 17</font></td><td><font color="green" size="2px">&nbsp;&nbsp;&nbsp;;&nbsp;&nbsp;&nbsp;</font></td><td><font color="green" size="1px"> 45/60 </font></td><td><font color="green" size="2px">&nbsp;&nbsp;&nbsp;;&nbsp;&nbsp;&nbsp;</font></td><td><font color="green" size="1px"> Sandy clay </font></td><td><font color="green" size="2px">&nbsp;&nbsp;&nbsp;#&nbsp;&nbsp;&nbsp;</font></td></tr>
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<tr><td><font color="green" size="2px">&nbsp;#&nbsp;&nbsp;&nbsp;</font></td><td><font color="green" size="1px"> 12.10 </font></td><td><font color="green" size="2px">&nbsp;&nbsp;&nbsp;;&nbsp;&nbsp;&nbsp;</font></td><td><font color="green" size="1px"> 6 11 18 32 n n 50/150 </font></td><td><font color="green" size="2px">&nbsp;&nbsp;&nbsp;;&nbsp;&nbsp;&nbsp;</font></td><td><font color="green" size="1px"> 10/30 </font></td><td><font color="green" size="2px">&nbsp;&nbsp;&nbsp;;&nbsp;&nbsp;&nbsp;</font></td><td><font color="green" size="1px"> Very dense grey silty fine SAND</font></td><td><font color="green" size="2px">&nbsp;&nbsp;&nbsp;#&nbsp;&nbsp;&nbsp;</font></td></tr>
</div>
...
print "<left><table width=\"700\" border=\"1\" cellspacing=\"1\" cellpadding=\"0\" bordercolor=\"#E4F3CF\" bgcolor=\"#ffffff\" >
		...
		<td width=\"175\"><a href=\"MyParticleSize.php?deep=".$id." \" style=\"display: block; width: 100%; height: 100%; text-decoration: none;\" title=\"Record Particle Size Distribution\">
            <font color=\"#000000\" size=\"1\">&nbsp;".$n1." | ".$n2." | ".$n3." | ".$n4." | ".$n5." | ".$n6." &nbsp; </font><font color=\"coral\" size=\"1\"> | ".$n7." |</font></a>
            </td>
		<td width=\"100\"><a href=\"MyAtterbergLimit.php?deep=".$id." \" style=\"display: block; width: 100%; height: 100%; text-decoration: none;\" title=\"Record Atterberg Limit\">
