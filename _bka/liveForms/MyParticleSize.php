...
if ($changeKP <> '' && $dcount==21){						
			$query_eb = "INSERT INTO eb_particlesize (idy, idz, depth,   ps5000, ps3350, ps2000, ps1180, ps0600, ps0425, ps0300, ps0212, ps0150, ps0063, ps0033, ps0024, ps0018, ps0013, ps0010, ps0007, ps0005, ps0004, ps0003, ps0001, regist_date) VALUES ({$_SESSION['idy']}, {$_SESSION['idz']}, {$_SESSION['depth']},'$ps5000','$ps3350','$ps2000','$ps1180','$ps0600','$ps0425','$ps0300','$ps0212','$ps0150','$ps0063','$ps0033','$ps0024','$ps0018','$ps0013','$ps0010','$ps0007','$ps0005','$ps0004','$ps0003','$ps0001',NOW())";	
...
if ($db = @mysql_connect (DB_HOST, DB_USER, DB_PASSWORD)) {
 ...
 if ( $chk_logger<>''){
 	...
 	$query = "DELETE FROM eb_particlesize WHERE idy='{$_SESSION['idy']}' and  idz='{$_SESSION['idz']}'";		
...
<form id="liveForm" action="MyParticleSize.php" method="post" onsubmit="if(!Validator.AllFieldsValidated()) return false;">
...
<div>
<tr><td><font color="gray" size="1px">PARTICLE SIZE (mm)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</font></td><td><font color="green" size="4px">%&nbsp;</font></td><td><td><font color="green" size="2px">PASSING</font></td></tr>
</div>
<tr>
<td><textarea cols="10" rows="25"  style="border: 0; color: red; background-color: #FDFECF" disabled="disabled">
5.000
3.350
2.000
1.180
...
<td><textarea cols="10" rows="25" id="tajuk" name="tajuk" onblur="Validator.Validate(this,'tajuklukisan');">
100;
100;
100;
100;
...
100;
100;</textarea></td>
<!--td><img alt='vector.tutsplus.com' border='0' height="350" width='350' src='../../galleries/cplants/wheel loader 50Z.jpg' style='border: medium none;' /></td-->
</tr>
...
<a href="MyAtterbergLimit.php?deep='.$_SESSION['idz'].'"><small>&nbsp;&nbsp;AtterbergLimit</small></a>
...
print "<left><table width=\"625\" border=\"1\" cellspacing=\"1\" 
        cellpadding=\"2\" bordercolor=\"#E4F3CF\" bgcolor=\"#FDFECF\">
         <tr valign=\"top\" >
            <td width=\"625\">
              <font color=\"#000000\" size=\"1\">PERCENTAGE PASSING</font>
            </td>
	    </tr>
        </table></left>";
$BIL=1;  
    $result=mysql_query("SELECT * FROM eb_particlesize WHERE idy='{$_SESSION['idy']}' and  depth='{$_SESSION['depth']}'") or die ('Error performing query');
...
print "<left><table width=\"625\" border=\"1\" cellspacing=\"1\" cellpadding=\"0\" bordercolor=\"#E4F3CF\" bgcolor=\"#ffffff\" height=\"25\">
		...
		<td width=\"625\"><a href=\"MyParticleSize.php?delete=".$id." \" onCLick=\"return confirmDelete();\" style=\"display: block; width: 100%; height: 100%; text-decoration: none;\" title=\"Record Particle Size Distribution\">
            <font color=\"#000000\" size=\"1\">".$ps5000." ".$ps3350." ".$ps2000." ".$ps1180." ".$ps0600." ".$ps0425." ".$ps0300." ".$ps0212." ".$ps0150." ".$ps0063." ".$ps0033." ".$ps0024." ".$ps0018." ".$ps0013." ".$ps0010." ".$ps0007." ".$ps0005." ".$ps0004." ".$ps0003." ".$ps0001." "."</font></a>
            </td>
	    </tr>
        </table></left>";
